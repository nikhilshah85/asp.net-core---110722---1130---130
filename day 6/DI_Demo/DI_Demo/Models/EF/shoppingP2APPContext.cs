...
{
    public partial class shoppingP2APPContext : DbContext
    {
        public shoppingP2APPContext()
        {
        }

        public shoppingP2APPContext(DbContextOptions<shoppingP2APPContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=WIN8\\NIKHILINSTANCE;database=shoppingP2APP;integrated security=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<OrdersList>(entity =>
            {
                entity.HasKey(e => e.OrderId)
                    .HasName("PK__ordersLi__0809335D3DB1B501");
            ...
            modelBuilder.Entity<ProductList>(entity =>
            {
                entity.HasKey(e => e.PId)
                    .HasName("PK__productL__DD36D562BB9163ED");
            ...
            modelBuilder.Entity<Register>(entity =>
            {
                entity.HasKey(e => e.DesiredUserName)
                    .HasName("PK__Register__8FB802681D157D29");
